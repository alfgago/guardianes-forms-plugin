...
const EVENT_LABELS: Record<string, string> = {
  ...
  docente_submit_participacion: 'Envio participación anual',
  supervisor_approve_entry: 'Supervisor aprobo reto',
  supervisor_request_correction: 'Supervisor solicito correccion',
  comite_validate_centro: 'Evento legado de comite',
  comite_reject_centro: 'Evento legado de comite',
  comite_add_observation: 'Evento legado de comite',
