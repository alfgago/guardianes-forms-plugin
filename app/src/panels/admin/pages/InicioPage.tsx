...
export function InicioPage() {
  ...
  return (
    <div>
      ...
      {stats && (
        <StatsGrid columns={3}>
          <StatCard label="Centros con matrícula" value={stats.centros} icon={<School size={24} />} color="#0369a1" bg="#e0f2fe" />
          <StatCard label="Cuentas docentes" value={stats.totalUsers} icon={<Users size={24} />} color="var(--gnf-forest)" bg="#dcfce7" />
